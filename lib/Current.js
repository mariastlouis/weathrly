    ...
    <div>
      <div className = "current">
        ...
        <div className = "date-city">
          ...
          <div class-name = "current-temp">
            <p> {props.currentWeather.avgTemp}&deg;</p>
          </div>
          <div className = "date">
            <p> {props.currentWeather.dateWeekDay},
             {props.currentWeather.dateMonth}
              {props.currentWeather.dateDay} </p>
          </div>
        </div>
